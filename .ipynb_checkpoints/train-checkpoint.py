...
# from bird_dataset import TextDataset
...
def main(args):
    ...
    dataset = ImagePaths('',  transform=transform)
    ...
    for epoch in range(args.epochs):
        ...
        for x, y in loader:
            ...
            with torch.no_grad():
                ...
                x = vae.encode(x).latent_dist.sample().mul_(0.23126199671607967)
            ...
            if train_steps % args.ckpt_every == 0 and train_steps > 0:
                ...
                dist.barrier()
        # image_m = torch.cat(image_list,0)
        # print(image_m.std())
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt", type=str, default='None',
                help="path to pre-trained checkpoint during fine-tuning).")
